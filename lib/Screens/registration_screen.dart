...
import 'package:searchshop/Screens/login_screen.dart';
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        SizedBox(height: 30,),
                        Text('Please provide your phone number and complete the Registration process', style: TextStyle(fontWeight: FontWeight.w500, fontSize: 20, color: Colors.black45),)
                      ],
                    ),
                  ),
                  Container(
